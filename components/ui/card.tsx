...
export function Card({ className, ...props }: HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("rounded-[28px] border border-border bg-card text-foreground shadow-[0_18px_45px_rgba(87,52,22,0.08)] backdrop-blur-sm", className)} {...props} />;
}
